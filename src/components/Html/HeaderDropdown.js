  ...
  dropAccnt() {
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
            <img src={'img/avatars/placeholder-profile.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
            John Smith
        </DropdownToggle>
        <DropdownMenu right>
            <a href="/#/login"><DropdownItem><i className="fa fa-lock"></i> Logout</DropdownItem></a>
        </DropdownMenu>
      </Dropdown>
    );
  }
